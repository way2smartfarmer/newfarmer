...
const footerLinks = [
  {
    ...
    links: [
      {
        name: 'Contact Us',
        redirect: 'https://www.way2agribusiness.com/contact.html',
      },
      {
        name: 'About Us',
        redirect: 'https://www.way2agribusiness.com/credentials.html',
      },
      {
        name: 'Careers',
        redirect: 'https://www.way2agribusiness.com/',
      },
      {
        name: 'way2smartfarmer Stories',
        redirect:
          'https://www.way2agribusiness.com/agritech-solutions/#/tab-agritech',
      },
      {
        name: 'Press',
        redirect: 'https://www.way2agribusiness.com/index.html',
      },
      {
        name: 'way2smartfarmer Wholesale',
        redirect: 'https://www.way2agribusiness.com/index.html',
      },
      {
        name: 'Corporate Information',
        redirect: 'https://www.way2agribusiness.com/agritech-solutions',
      },
    ],
  },
  {
      ...
      {!adminRoute && (
        <>
            ...
            <div className="w-full sm:w-5/12 my-6 mx-5 sm:mx-0 flex flex-col sm:flex-row gap-2 sm:gap-0 justify-between">
              <div className="w-full sm:w-1/2">
                ...
                <p className="mt-2 leading-5">
                  Way2Agri Business Private Limited,
                  <br />
                  Yeshwanthpur &<br />
                  Bengaluru, 560103,
                  <br />
              ...
              <div className="w-full sm:w-1/2">
                ...
                <p className="mt-2 leading-5">
                  ...
                  <br />
                  Telephone:{' '}
                  <a className="text-primary-blue" href="tel:9449004956">
                    9449004956
                  </a>
                </p>
              </div>
          ...
          <div className="px-16 py-6 w-full bg-primary-darkBlue hidden sm:flex justify-between items-center text-sm text-white">
            <a
              href="https://www.way2agribusiness.com/index.html"
              target="_blank"
              rel="noreferrer"
            ...
            <span>
              ...
              https://www.way2agribusiness.com/
            </span>
